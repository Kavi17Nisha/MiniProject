...
class UserController extends Controller
{
    ...
    function register(Request $req)
    {
        ...
        */
        ...
        return '<script type="text/javascript">alert("Successfully registered"); window.location.href="/login"</script>';
        //return view('viewuser',['users' => DB::table('users')->paginate(5)]); kavi edited
        //$req->session()->put('user',$user); kavi edited
    }
    ...
    function deleteuser(Request $req)
    {
        ...
        return '<script type="text/javascript">alert("Successfully deleted"); window.location.href="/userlist"</script>';
        //return view('promptdeleteuser'); kavi edited
    }
    ...
    function search(Request $req)
    {
        ...
        ['users'=> DB::table('users')
           ...
           ->orWhere('name', 'like', '%'. $req->search .'%')->paginate(3)]
